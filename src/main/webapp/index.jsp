...
<head>
    ...
    <link rel="stylesheet" href="css/others/meanmenu.min.css" type="text/css">
    <link rel="stylesheet" href="css/others/owl.carousel.min.css" type="text/css">
    <link rel="stylesheet" href="css/others/font-awesome.min.css" type="text/css">
    <link rel="stylesheet" href="css/others/pe-icon-7-stroke.css" type="text/css">
